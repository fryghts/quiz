...
const quizData = {
  ...
  questions: [
    ...
    // ====== Вопрос 10 ======
    {
      ...
      answerText:
        "Куст – это площадка, на которой расположены устья газовых скважин. Устье называют ёлкой, а штурвальный ключ  - мартышкой. А вот бабочка не прижилась в профессиональном сленге.",
      infoTextConfig: {
    ...
    // ====== Вопрос 11 ======
    {
      ...
      question:
        "Для диагностики магистральных трубопроводов используются внутритрубные снаряды. Благодаря чему эти роботы перемещаются?",
      questionText: {
        position: { left: 230, top: 138 },
        size: { width: 760, height: 150 },
        fontSize: 40,
        lineHeight: 1.1,
      },
    ...
    // ====== Вопрос 12 ======
    {
      ...
      question:
        "Как роботы-дефектоскопы перемещаются внутри компрессорных станций? ",
      questionText: {
        position: { left: 240, top: 140 },
        size: { width: 740, height: 150 },
        fontSize: 49,
      ...
      options: [
        "С помощью системы магнитов",
        "Тянутся на специальной стальной нити",
        "Самостоятельно, управляются с помощью пульта",
